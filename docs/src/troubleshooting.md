...
[discuss with us](https://github.com/singularitti/Thinkers.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/singularitti/Thinkers.jl/issues/new) or
[submit a PR](https://github.com/singularitti/Thinkers.jl/compare) with suggestions.
