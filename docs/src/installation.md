...
[Thinkers](https://github.com/singularitti/Thinkers.jl).
...
version of Thinkers, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/singularitti/Thinkers.jl"
```
...
our [GitHub repository](https://github.com/singularitti/Thinkers.jl)
for new releases.
Once we release a new version, you can update Thinkers by typing
...
## Uninstall and reinstall Thinkers
